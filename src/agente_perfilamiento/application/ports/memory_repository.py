...
class MemoryRepository(ABC):
    ...
    @abstractmethod
    def get_recent(self, agent_name: str, session_id: str, limit: Optional[int] = None) -> List[ShortTermMemoryItem]:  # pragma: no cover - interface
        ...

    @abstractmethod
    def prune(self, agent_name: str, session_id: str, ttl_seconds: Optional[int], max_items: Optional[int]) -> None:  # pragma: no cover - interface
        ...
